...
public class PredecesorsCheck_TextGen extends TextGenDescriptorBase {
  @Override
  public void generateText(final TextGenContext ctx) {
    final TextGenSupport tgs = new TextGenSupport(ctx);
    tgs.append("predecesorTypeCheck('");
    ...
    tgs.append(", ");
    Linter_functions.toStringArray(SLinkOperations.getChildren(ctx.getPrimaryInput(), MetaAdapterFactory.getContainmentLink(0xc400f4156edc4c5fL, 0xa0ceccbb04f551e6L, 0x686f417f617be32cL, 0x686f417f617be32dL, "requiredPredecesors")), ctx);
    tgs.append(");");
    tgs.newLine();
  }
}
