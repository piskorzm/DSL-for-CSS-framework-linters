...
public class MisuseCheck_TextGen extends TextGenDescriptorBase {
  ...
  public void generateText(final TextGenContext ctx) {
    ...
    tgs.append("'], ");
    tgs.append("['");
    Linter_functions.toStringList(SLinkOperations.getChildren(ctx.getPrimaryInput(), MetaAdapterFactory.getContainmentLink(0xc400f4156edc4c5fL, 0xa0ceccbb04f551e6L, 0x472d73cdfe35f711L, 0x472d73cdfe35f712L, "required")), ctx);
    tgs.append("']);");
    tgs.newLine();
  }
}
